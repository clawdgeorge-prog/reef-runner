...
- Finding past conversations about topics
- Searching for things you don't remember exactly how they were worded
...
### ⚠️ CRITICAL: Always Check Vector Memory AND File System
...
**NEVER say "I don't remember" without checking ALL of these locations.**

### 📋 End of Session Memory

**Always update memory at the end of each session with Brant:**
1. Create/update `memory/YYYY-MM-DD.md` with session details
2. Update `MEMORY.md` with any new long-term information
3. Include: what was done, what worked, what didn't, new preferences, earnings results, etc.

This ensures continuity across sessions — Brant can pick up where we left off.
...
Read `MODEL_ROUTING.md` when deciding between OpenAI and MiniMax.

Short version:
- Main session with Brant → prefer OpenAI when configured
- Subagents / cron / scraping / routine background work → prefer MiniMax
- Do not move worker jobs to OpenAI unless Brant explicitly agrees
